...
class CheckoutDataBuilder implements BuilderInterface
{
    ...
    public function build(array $buildSubject)
    {
        ...
        //   "paymentMethod":{
        //      "type":"scheme",
        //      "storedPaymentMethodId":"7219687191761347"                  ==> gateway_token in vault_payment_token table
        //   },
        //   "reference":"YOUR_ORDER_NUMBER",
        ...
        $requestBody = $this->stateData->getStateData($order->getQuoteId()); // so stateData also has a quote? or are we getting this information from the quote_payment table?
