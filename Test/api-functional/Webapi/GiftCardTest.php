...
class GiftCardTest extends WebapiAbstract
{
     ...
     */
    #[
        DataFixture(Customer::class, ['email' => 'customer1@example.com'], 'customer1'),
        DataFixture(CustomerCart::class, ['customer_id' => '$customer1.id$'])
    ]
    public function testSaveReadRemoveStateDataCustomer()
    {
        $customerToken = $this->customerTokenService->createCustomerAccessToken('customer1@example.com', 'password');
    ...
    /**
     * Tests order placement using single giftcard + credit card
     */
    #[
        DataFixture(Product::class, ['price' => 100], 'product1'),
        DataFixture(Indexer::class),
        DataFixture(GuestCart::class, as: 'guestCart1'),
        DataFixture(AddProductToCart::class, ['cart_id' => '$guestCart1.id$', 'product_id' => '$product1.id$']),
        DataFixture(SetShippingAddress::class, ['cart_id' => '$guestCart1.id$']),
