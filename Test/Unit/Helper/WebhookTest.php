...
class WebhookTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->adyenOrderPaymentCollectionFactory = $this->createMock(OrderPaymentCollectionFactory::class);
        ...
        $this->sut = new Webhook(
            ...
            $this->createMock(AgreementFactory::class),
            $this->createMock(AgreementCollectionFactory::class),
            $this->createMock(PaymentRequest::class),
            $this->adyenOrderPaymentCollectionFactory,
            $this->createMock(OrderStatusCollectionFactory::class),
            ...
            $this->createMock(PaymentTokenFactoryInterface::class),
            ...
            $this->createMock(PaymentFactory::class),
