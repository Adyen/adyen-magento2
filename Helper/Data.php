...
class Data extends AbstractHelper
{
    ...
    {
		if ($amount == null) $amount = 0;	// PHP 8 does not accept first param to be NULL, if so (for example with bundle products) mimic PHP 7 behaviour by setting the value to 0
