...
{
    final const MODULE_NAME = 'adyen-magento2';
    final const APPLICATION_NAME = 'Magento 2 plugin';
    final const TEST = 'test';
    final const LIVE = 'live';
    final const LIVE_AU = 'live-au';
    final const LIVE_US = 'live-us';
    final const LIVE_IN = 'live-in';
    final const PSP_REFERENCE_REGEX = '/(?P<pspReference>[0-9.A-Z]{16})(?P<suffix>[a-z\-]*)/';
    final const AFTERPAY = 'afterpay';
    final const AFTERPAY_TOUCH = 'afterpaytouch';
    final const KLARNA = 'klarna';
    final const RATEPAY = 'ratepay';
    final const FACILYPAY = 'facilypay_';
    final const AFFIRM = 'affirm';
    final const CLEARPAY = 'clearpay';
    final const ZIP = 'zip';
    final const PAYBRIGHT = 'paybright';
    final const SEPA = 'sepadirectdebit';
    final const MOLPAY = 'molpay_';
    final const ATOME = 'atome';
