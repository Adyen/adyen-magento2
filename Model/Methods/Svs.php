...
class Svs extends AdyenPaymentMethod implements PaymentMethodInterface
{
	public const CODE = 'adyen_svs';
	public const TX_VARIANT = 'svs';
	public const NAME = 'SVS Giftcard';
