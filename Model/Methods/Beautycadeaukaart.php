...
class Beautycadeaukaart extends AdyenPaymentMethod implements PaymentMethodInterface
{
	public const CODE = 'adyen_beautycadeaukaart';
	public const TX_VARIANT = 'beautycadeaukaart';
	public const NAME = 'Beauty Giftcard';
