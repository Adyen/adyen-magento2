...
class Givex extends AdyenPaymentMethod implements PaymentMethodInterface
{
	public const CODE = 'adyen_givex';
	public const TX_VARIANT = 'givex';
	public const NAME = 'Givex Giftcard';
