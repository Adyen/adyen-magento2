...
class Decadeaukaart extends AdyenPaymentMethod implements PaymentMethodInterface
{
	public const CODE = 'adyen_decadeaukaart';
	public const TX_VARIANT = 'decadeaukaart';
	public const NAME = 'DeCadeaukaart Giftcard';
