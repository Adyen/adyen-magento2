...
class PlatformIntegrator extends Value
{
    /**
    ...
    /**
     * This method resets the value of `platform_integrator` field
     * if the value of `has_platform_integrator` field is set to `No`.
     *
     * @return void
     */
